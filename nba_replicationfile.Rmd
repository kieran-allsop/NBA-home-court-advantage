...
This is an R Markdown document that replicated the data collection, sorting, and analysis from the paper [All-star fans and home court advantage](https://www.aei.org/research-products/working-paper/all-star-fans-and-home-court-advantage/). The code was originally run on R.4.0.1. Updated versions of R may have been released since this replication file was written.
